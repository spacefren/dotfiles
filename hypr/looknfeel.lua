...
hl.animation({ leaf = "windowsIn", enabled = true, speed = 4.1, bezier = "standardDecel", style = "popin 87%" })
hl.animation({ leaf = "windowsOut", enabled = true, speed = 1.49, bezier = "emphasizedAccel", style = "popin 87%" })
...
hl.config({
    general = {
        ...
        col              = {
            active_border   = colors.primary:gsub("ff", "cc", 1),
